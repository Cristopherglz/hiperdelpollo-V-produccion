            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <div className="text-center">
                  <Trophy className={`w-6 h-6 mx-auto mb-1 ${formData.tipoSorteo === 'posiciones' ? 'text-pollo-amarillo' : 'text-pollo-marron/50'}`} />
              ...
              >
                <div className="text-center">
                  <Users className={`w-6 h-6 mx-auto mb-1 ${formData.tipoSorteo === 'cantidad' ? 'text-pollo-amarillo' : 'text-pollo-marron/50'}`} />
