...
export function HomeScreen({ onNavigate }: HomeScreenProps) {
  ...
  return (
    <div className="min-h-screen w-full pb-24">
      {/* Header */}
      <div className="bg-pollo-amarillo px-6 pt-12 pb-8 rounded-b-[2.5rem] shadow-pollo-lg relative overflow-hidden">
        {/* Decorations */}
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        {prediccionesHabilitadas && (
          ...
          >
            <div className="absolute inset-0 bg-pollo-marron" />
            <div className="absolute inset-0 bg-[url('https://www.transparenttextures.com/patterns/soccer.png')] opacity-10" />
              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center gap-2 mb-2">
                    <Globe className="w-4 h-4 text-pollo-amarillo" />
                    <span className="text-pollo-amarillo text-xs font-bold uppercase tracking-wider">Mundial 2026</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    <span className="bg-pollo-amarillo text-pollo-marron text-xs font-bold px-3 py-1.5 rounded-full">
                      Predecir Ahora
                    </span>
                    <ChevronRight className="w-4 h-4 text-white/60" />
                  </div>
                </div>
                <div className="w-16 h-16 bg-pollo-amarillo rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                  <Trophy className="w-8 h-8 text-pollo-marron" />
                </div>
              </div>
            </div>
          </div>
              ...
              <div className="flex items-center justify-between">
                ...
                {prediccionesAcertadas.length > 0 && (
                  <div className="text-right">
                    <p className="text-2xl font-black text-pollo-amarillo">{prediccionesAcertadas.length}</p>
                    <p className="text-sm text-pollo-marron">Con Triple Chance</p>
                  </div>
                )}
              </div>
            </div>
  ...
  return (
    ...
    >
      <div className="flex gap-4">
        <div className="w-20 h-20 bg-pollo-amarillo rounded-xl flex items-center justify-center flex-shrink-0">
