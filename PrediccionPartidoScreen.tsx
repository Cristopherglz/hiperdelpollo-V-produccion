      ...
      <div className="p-4 space-y-4">
        ...
        <Card className="overflow-hidden">
          <CardContent className="p-4">
            ...
            {partido.grupo && (
              <Badge className="mb-3 bg-pollo-amarillo text-pollo-marron">
                Grupo {partido.grupo}
              </Badge>
            )}
        ...
        {/* Info Triple Chance */}
        <div className="bg-pollo-amarillo/30 rounded-xl p-4 border-2 border-pollo-amarillo">
          <div className="flex items-start gap-3">
            <div className="bg-pollo-amarillo p-2 rounded-xl shrink-0 shadow-lg">
