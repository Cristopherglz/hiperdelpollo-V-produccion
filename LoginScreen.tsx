      ...
      <div className="flex-1 flex flex-col px-6 pb-8 relative z-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 flex-1">
          ...
          <div className="flex justify-end">
            <button 
              ...
              className="text-sm text-pollo-marron font-semibold hover:text-pollo-amarillo transition-colors"
            >
        ...
        <div className="text-center pt-6">
          <p className="text-pollo-marron/60">
            ...
            <button
              onClick={onRegister}
              className="text-pollo-marron font-bold hover:text-pollo-amarillo transition-colors"
            >
              Registrate
            </button>
          </p>
