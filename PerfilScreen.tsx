...
export function PerfilScreen({ onBack, onLogout }: PerfilScreenProps) {
  ...
  return (
    <div className="min-h-screen w-full pb-24">
      {/* Header */}
      <div className="bg-pollo-amarillo px-6 pt-12 pb-6 rounded-b-[2.5rem] shadow-pollo-lg relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center gap-4">
            <div className="w-20 h-20 bg-pollo-fondo-claro/30 backdrop-blur-sm rounded-2xl flex items-center justify-center">
              <span className="text-3xl font-black text-pollo-marron">
            ...
            <div>
              ...
              <p className="text-pollo-marron/80 text-sm">{user?.email}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="px-6 py-6 space-y-6">
        ...
        <div>
          ...
          <div className="space-y-3">
            {/* Nombre */}
            <div className="flex items-center gap-4 p-4 bg-pollo-fondo-claro/80 rounded-2xl border border-pollo-amarillo/30">
              ...
              <div className="flex-1">
                ...
                {isEditing ? (
                  <input
                    ...
                    className="w-full font-semibold text-pollo-marron bg-transparent border-b border-pollo-amarillo focus:outline-none"
                  />
                ) : (
            ...
            {/* Email (no editable) */}
            <div className="flex items-center gap-4 p-4 bg-pollo-fondo-claro/80 rounded-2xl border border-pollo-amarillo/30">
              <div className="w-10 h-10 bg-pollo-marron/20 rounded-xl flex items-center justify-center">
                <Mail className="w-5 h-5 text-pollo-marron" />
              </div>
              <div className="flex-1">
            ...
            <div className="flex items-center gap-4 p-4 bg-pollo-fondo-claro/80 rounded-2xl border border-pollo-amarillo/30">
              <div className="w-10 h-10 bg-pollo-amarillo/20 rounded-xl flex items-center justify-center">
                <Phone className="w-5 h-5 text-pollo-amarillo" />
              </div>
              <div className="flex-1">
